            ...
            makeButton: {
                value: function (cfg) {
                    ...
                    if (cfg.url) {
                        ...
                        button = $('<a data-button="' + cfg.name + '" id="kb-' + cfg.name + '-btn" class="btn btn-' + (cfg.style || 'default') + (cfg.class ? ' ' + cfg.class : '') + ' xnavbar-btn xkb-nav-btn" role="button" href="' + cfg.url + '" ' + target + '>' +
                            '  <span class="fa fa-' + cfg.icon + '" style="' + iconStyle + '"></span>' + label + '</a>');

                    } else {
                        button = $('<button data-button="' + cfg.name + '" id="kb-' + cfg.name + '-btn" class="btn btn-' + (cfg.style || 'default') + ' xnavbar-btn xkb-nav-btn">' +
